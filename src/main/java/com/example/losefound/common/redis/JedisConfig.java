package com.example.losefound.common.redis;
...
//        jedisPoolConfig.setMinIdle(minIdle);
        JedisPool jedisPool = new JedisPool(jedisPoolConfig,host,port,timeout,"".equals(password.trim()) ? null : password,database);
        System.out.println("---------------------"+host+","+port+","+password+",database"+database);
        return  jedisPool;
    }
